...
**LLM 评估基础**
[Q1 传统指标局限性](#q1传统-nlp-评估指标bleurougerouge在评估-llm-时有哪些局限性) · [Q2 基准测试设计与局限](#q2mmluhumaneval-等基准测试是如何设计的有什么局限性) · [Q3 LLM-as-a-Judge](#q3什么是-llm-as-a-judge如何设计一个针对特定能力的评估框架) · [Q4 定制化评估框架](#q4如何为特定业务场景如客服写作助手设计定制化评估框架)

**Agent 评估**
[Q5 Agent 评估的复杂性](#q5为什么-agent-评估比-llm-评估更复杂有哪些专用的-agent-评估-benchmark) · [Q6 过程指标](#q6agent-评估中除了最终结果正确率还应该关注哪些过程指标) · [Q7 非确定性处理](#q7如何处理-agent-系统的非确定性同样的输入今天对明天错)

**评估实践**
[Q8 红队测试](#q8什么是红队测试red-teaming如何系统性地发现-llm-的安全漏洞) · [Q9 人工评估流程设计](#q9如何设计人工评估流程如何保证标注一致性) · [Q10 线上持续监控](#q10llm-上线后如何持续监控其性能有哪些典型的线上监控指标)
